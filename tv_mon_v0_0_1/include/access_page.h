          ...
          <div style='font-size:200%;color:white;'>
            ...
            <table style="align-self: center;">
              ...
              <tr>
                ...
                <td><input type='number' id='time' name='time' min='0' max='510' step='5' value='5'
                  style='font-size:100%;border-radius:10px;max-width:50%;text-align: center;' required></td>
              </tr>
              <br>
              <tr>
              <td><label for='amnt'>Paid($) :</label></td>
              <td><input type='number' id='amnt' name='amnt' min='0' max='255' step='1' value='0'
              style='font-size:100%;border-radius:10px;max-width:50%;text-align: center;' required></td>
              </tr>
            </table>
            </center>
