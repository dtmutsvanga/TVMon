  ...
  <center>
      ...
      <div class='container'>
        ...
        <div class='sdata'>
          ...
          <table class='sdata'>
            ...
            <tr>
              <td><button id='RS1' onclick='resetStxn(1)'>RESET</button></th>
              <td><button id='RS2'onclick='resetStxn(2)'>RESET</button></th>
            </tr>
          </table>
        </div>
        <p></p>
    ...
    <script>
      ...
      function on_load_done() {
        ...
        getData("date_time", "date_time", false);
        get_station_data();
      }
      ...
      function get_station_data() {
        switch (_ctr) {
          case 0:
            getData("st1_tm", "st1_tm", true);
            //get_station_data.ctr=1;
            _ctr=1;
            break;
          case 1:
            getData("st2_tm", "st2_tm", true);
            _ctr=0;
        ...
        setTimeout(get_station_data, 10000);
      }
      ...
      function validateInput() {
        ...
        var data = chkdStation + checkdGame + p_time.toString();
      ...
      function resetStxn(staxn_id){
        var req= "reset_st"+staxn_id.toString();
       // alert(req);
        if (!ajaxRequest) {
